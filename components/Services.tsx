...
const keys = ["evidence", "payroll", "reporting", "onec", "outsourcing", "consulting"] as const;
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {keys.map((key, i) => (
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-navy">{t(`items.${key}.title`)}</h3>
              <p className="mt-2 text-sm text-slate-600">{t(`items.${key}.desc`)}</p>
            </motion.article>
          ))}
        </div>
      </div>
